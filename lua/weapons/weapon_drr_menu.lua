...
function SWEP:DrawHUD()
	...
	draw.SimpleText("Left click - upgrades / Right click - weapons menu (admin only) / Reload key - friends menu", "DronesRewrite_customfont2", ScrW() / 2, ScrH() - 220, Color(255, 255, 255, 200), TEXT_ALIGN_CENTER)
end
