...
-- To summon hell try your chance by shooting yourself with hell skulls
-- Drone - Devil
...
local function DoHell()
	if DRONES_REWRITE.ClientCVars.DisableHell:GetBool() then return end
...
concommand.Add("dronesrewrite_do_hell", DoHell)
concommand.Add("dronesrewrite_end_hell", End) 